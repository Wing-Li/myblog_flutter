...
import 'package:lylblog/view/route/my_page_fade_route_builder.dart';
import 'package:lylblog/view/route/my_page_slide_route_builder.dart';
...
class MyUtils {
  ...
  /// 跳转页面，带渐变动画
  static void startPageGradient(BuildContext context, Widget page, {int duration = 500}) async {
    Navigator.push(context, MyPageFadeTransitionRouteBuilder(page, duration: duration));
  }

  /// 从下往上划出
  static void startPageUpAnim(BuildContext context, Widget page, {int duration = 500}) async {
    Navigator.push(context, MyPageSlideTransitionRouteBuilder(page, duration: duration));
  }
  ...
  static void gotoAppStore() {
    ...
    if (Platform.isIOS) {
      ...
      appStoreComment = "https://play.google.com/store/apps/details?id=com.dobestthingsscenter.spice";
    }
  ...
  static void log(Object object) {
    if (!MyUtils.isProd()) logger.d(object);
  }
  ...
  static void showToast(String msg, {bool isLongTime = false}) {
    BotToast.showNotification(
      title: (_) => Text(msg, style: TextStyles.text(16), textAlign: TextAlign.center),
  ...
  static void showLoading(BuildContext context, {String loadText = "loading..."}) {
    ...
    BotToast.showCustomLoading(toastBuilder: (CancelFunc cancelFunc) {
      return LoadingIndicator(indicatorType: Indicator.orbit, color: MyTheme.text_white_gray_light);
    });
  }
